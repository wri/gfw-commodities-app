      ...
      */
      function generateSingleMillTableBottom(mill) {
        ...
        var frag = '<table class="single-mill-table-content-v2">';
            ...
            frag += '<tr><td>Fire activity</td><td class="' + mill.fire.extent.rank + smallSwatch + mill.fire.extent.rank + '</td><td>' + Math.round(mill.fire.extent.amount) + ' fires/1000 ha per year</td>' +
