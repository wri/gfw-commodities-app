      ...
      */
      function generateSingleMillTableBottom(mill) {
        ...
        var frag = '<table class="single-mill-table-content-v2">';
            ...
            frag += '<tr><td>Rate of tree cover loss</td><td class="' + mill.tree_cover.loss.rank + smallSwatch + mill.tree_cover.loss.rank + '</td><td>' + Math.round(mill.tree_cover.loss.amount) + ' ha/year lost</td>' +
                    '<td>Rate of tree cover loss</td><td class="' + mill.tree_cover.extent.rank + smallSwatch + mill.tree_cover.extent.rank + '</td><td>' + Math.round(mill.tree_cover.extent.amount) + ' ha/year lost</td></tr>';
            frag += '<tr><td>Tree cover loss on primary forest</td><td class="' + mill.primary_forest.loss.rank + smallSwatch + mill.primary_forest.loss.rank + '</td><td>' + Math.round(mill.primary_forest.loss.amount) + ' ha of primary forest lost</td>' +
                    '<td>Area in primary forest</td><td class="' + mill.primary_forest.extent.rank + smallSwatch + mill.primary_forest.extent.rank + '</td><td>' + Math.round(mill.primary_forest.extent.amount) + '% of total area comprised of primary forest</td></tr>';
            frag += '<tr><td>Tree cover loss on peat</td><td class="' + mill.peat.loss.rank + smallSwatch + mill.peat.loss.rank + '</td><td>' + Math.round(mill.peat.loss.amount) + ' ha of peat lost</td>' +
                    '<td>Area in peat</td><td class="' + mill.peat.extent.rank + smallSwatch + mill.peat.extent.rank + '</td><td>' + Math.round(mill.peat.extent.amount) + '% of total area comprised of peat</td></tr>';
            frag += '<tr><td>Tree cover loss on protected areas</td><td class="' + mill.protected_areas.loss.rank + smallSwatch + mill.protected_areas.loss.rank + '</td><td>' + Math.round(mill.protected_areas.loss.amount) + ' ha of protected area lost</td>' +
