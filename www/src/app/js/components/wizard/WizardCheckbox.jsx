      ...
      return (
        <div className='wizard-checkbox-container'>
          ...
          </div>
          {
            ...
            <span className='tcd-percentage-label'>Analyze at </span>
          ...
          }
          {
            ...
            <div className={gladClassName} data-value={this.props.childValue}>
              <span className='custom-check' onClick={this.toggleGladConfidence}>
                <span />
              </span>
              <a className='wizard-checkbox-label' onClick={this.toggleGladConfidence}>{this.props.childLabel}</a>
