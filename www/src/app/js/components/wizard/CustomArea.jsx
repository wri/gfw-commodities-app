      ...
      return (
        <div className='custom-area'>
          ...
          <div className='drawing-tools'>
						<div className='drawing-tool-button' id='draw-coordinates' data-label={AnalyzerConfig.customArea.customCoordLabel} onClick={this.drawToolClicked}>{AnalyzerConfig.customArea.customCoordLabel}</div>
            ...
            <div className='drawing-tool-button' id='draw-upload' data-label={AnalyzerConfig.customArea.uploadLabel} onClick={this.drawToolClicked}>{AnalyzerConfig.customArea.uploadLabel}</div>
          </div>
